...
public class Test {
    public static void main(String[] args){
        ...
        LinkedList test1 = grid.createConnection(1, 7);
        LinkedList test2 = grid.createConnection(6, 1);
        LinkedList test3 = grid.createConnection(6, 7);
        LinkedList test4 = grid.createConnection(6, 11);
        LinkedList test5 = grid.createConnection(11, 12);
        LinkedList test6 = grid.createConnection(12, 7);
        LinkedList test7 = grid.createConnection(12, 16);
        LinkedList test8 = grid.createConnection(16, 11);
//        LinkedList test9 = grid.createConnection(2, 1);
//        LinkedList test10 = grid.createConnection(9, 8);
//        LinkedList test11 = grid.createConnection(9, 14);
